export default ({ store }, inject) => {
  ...
  inject('generalSeo', (title) => {
    return {
      title: title,
      meta: [
        { name: 'description', hid: 'description', content: store.state.site.description },
        { name: 'keywords', hid: 'keywords', content: store.state.site.keywords },
  ...
  inject('articleSeo', (article) => {
    return {
      title: article.title,
      meta: [
        { name: 'description', hid: 'description', content: article.description },
        ...
        { name: 'og:type', content: 'website' },
        { name: 'og:url', content: `${store.state.site.url}/blog/${article.slug}` },
